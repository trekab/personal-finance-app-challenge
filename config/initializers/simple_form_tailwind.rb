...
SimpleForm.setup do |config|
  ...
  config.error_notification_class = "alert alert-error alert-soft mb-2"
  ...
  config.wrappers :vertical_form, class: "mb-6" do |b|
    ...
    b.use :input, class: "input w-full", error_class: "is-invalid", valid_class: "is-valid"
  ...
  config.wrappers :vertical_text_area, class: "mb-6" do |b|
    ...
    b.optional :readonly
    b.use :label, class: "form-label"
    b.use :input, class: "textarea w-full", error_class: "is-invalid", valid_class: "is-valid"
    b.use :full_error, wrap_with: { class: "invalid-feedback" }
    b.use :hint, wrap_with: { class: "form-text" }
  end
  ...
  config.wrappers :vertical_boolean, tag: "fieldset", class: "mb-6" do |b|
    ...
    b.wrapper :form_check_wrapper, class: "flex items-center" do |bb|
      bb.use :input, class: "h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500", error_class: "is-invalid", valid_class: "is-valid"
      bb.use :label, class: "form-label"
  ...
  config.wrappers :vertical_checkbox, item_wrapper_class: "flex items-center mb-3", item_label_class: "form-label", tag: "fieldset", class: "mb-6" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: "legend", class: "text-base font-medium text-gray-900 mb-3" do |ba|
      ba.use :label_text
    end
    b.use :input, class: "checkbox", error_class: "border-red-500 focus:ring-red-500", valid_class: "is-valid"
    b.use :full_error, wrap_with: { class: "mt-2 text-sm text-red-600 block" }
    b.use :hint, wrap_with: { class: "form-text" }
  end

  config.wrappers :vertical_radio, item_wrapper_class: "flex items-center mb-3", item_label_class: "form-label", tag: "fieldset", class: "mb-6" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: "legend", class: "text-base font-medium text-gray-900 mb-3" do |ba|
      ba.use :label_text
    end
    b.use :input, class: "radio", error_class: "border-red-500 focus:ring-red-500", valid_class: "is-valid"
    b.use :full_error, wrap_with: { class: "mt-2 text-sm text-red-600 block" }
    b.use :hint, wrap_with: { class: "form-text" }
  end

  # vertical input for inline radio buttons and check boxes
  config.wrappers :vertical_collection_inline, item_wrapper_class: "inline-flex items-center mr-6", item_label_class: "form-label", tag: "fieldset", class: "mb-6" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: "legend", class: "text-base font-medium text-gray-900 mb-3" do |ba|
      ba.use :label_text
    end
    b.use :input, class: "h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500", error_class: "border-red-500 focus:ring-red-500", valid_class: "is-valid"
    b.use :full_error, wrap_with: { class: "mt-2 text-sm text-red-600 block" }
    b.use :hint, wrap_with: { class: "form-text" }
  end
  ...
  config.wrappers :vertical_file, class: "mb-6" do |b|
    ...
    b.use :input, class: "block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100", error_class: "is-valid", valid_class: "is-invalid"
    b.use :full_error, wrap_with: { class: "invalid-feedback" }
    b.use :hint, wrap_with: { class: "form-text" }
  end
  ...
  config.wrappers :horizontal_boolean, class: "mb-6 grid grid-cols-12 gap-4" do |b|
    ...
    b.wrapper :grid_wrapper, class: "col-span-9 col-start-4" do |wr|
      wr.wrapper :form_check_wrapper, class: "flex items-center" do |bb|
        bb.use :input, class: "h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500", error_class: "border-red-500 focus:ring-red-500", valid_class: "is-valid"
        bb.use :label, class: "form-label"
        bb.use :full_error, wrap_with: { class: "invalid-feedback" }
        bb.use :hint, wrap_with: { class: "form-text" }
      end
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: "flex items-center mb-3", item_label_class: "form-label", class: "mb-6 grid grid-cols-12 gap-4" do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: "col-span-3 text-sm font-medium text-gray-700 pt-2"
    b.wrapper :grid_wrapper, class: "col-span-9" do |ba|
      ba.use :input, class: "h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500", error_class: "border-red-500 focus:ring-red-500", valid_class: "is-valid"
  ...
  config.wrappers :horizontal_collection_inline, item_wrapper_class: "inline-flex items-center mr-6", item_label_class: "form-label", class: "mb-6 grid grid-cols-12 gap-4" do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: "col-span-3 text-sm font-medium text-gray-700 pt-2"
    b.wrapper :grid_wrapper, class: "col-span-9" do |ba|
